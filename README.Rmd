...
![Figure 1A. A schematic representation of the Neighbor-seq workflow](Figure 1A.png)
...
```{r  dpi=256, fig.height = 3, fig.width = 3, out.width="35%", out.height="35%", fig.align="center"}
rf = multiplet_rf(am)
...
```{r dpi=256, fig.height = 2.5, fig.width = 5, out.width="75%", out.height="75%", fig.align="center"}
...
```{r echo = T, results = 'hide', dpi=256, fig.height=2.5, fig.width=5, out.width="75%", out.height="75%", fig.align="center"}
set.seed(0) # for reproducibility
# ns.data = prep_cell_mat(ge = data, celltypes = meta.data$Cluster, logfc.threshold = 0.5)
